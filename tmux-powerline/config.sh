...
export TMUX_POWERLINE_SEG_MAILCOUNT_GMAIL_USERNAME="michaelmonetized"
...
# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/Users/michael/.now_playing.log"
